...
a persistence unit "servidorUzhcaJonathanPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "servidorUzhcaJonathan\pom.xml":
...
artifact ("servidorUzhcaJonathan.war") is already built. You can build
